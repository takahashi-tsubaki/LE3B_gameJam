...
// 電池の当たり判定用
//電池
const unsigned short COLLISION_ATTR_POWERCHIP = 0b1 << 6;
//カーソル
const unsigned short COLLISION_ATTR_CURSOR = 0b1 << 7;
//設置場所
const unsigned short COLLISION_ATTR_POWERCHIP_AREA = 0b1 << 8;