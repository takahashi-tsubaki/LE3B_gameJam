...
void SceneObjects::Initialize(SceneManager* controller)
{
	...
	Sprite::LoadTexture(4, L"Resources/dash.png");
	Sprite::LoadTexture(5, L"Resources/jump.png");

	Sprite::LoadTexture(6, L"Resources/tyokuden1.png");
	Sprite::LoadTexture(7, L"Resources/tyokuden2.png");
	Sprite::LoadTexture(8, L"Resources/tyokuden3.png");
	Sprite::LoadTexture(9, L"Resources/tyokuden4.png");
	Sprite::LoadTexture(10,L"Resources/tyokuden5.png");
	Sprite::LoadTexture(11,L"Resources/tyokuden6.png");
